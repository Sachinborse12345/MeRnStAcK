...
str = "Hii askdnfk";//best way to write string can add single quote , double quote in sting 
...
str = "hiic";
console.log(str.replaceAll("hc", "hd"));
...
substring
console.log("hii raj hii".indexOf("hii", 1));// will start search from index 1
